...
``` bash
cd /path/to/vitaflow/
python vitaflow/bin/vf_engine.py --config_python_file=examples/cifar10/classifier_config.py --mode=run_iterator
python vitaflow/bin/vf_engine.py --config_python_file=examples/cifar10/classifier_config.py --mode=train
```
"""
import os
