...
import os
import sys
from vitaflow import models  # pylint: disable=unused-import
from vitaflow.data_generators import problems as problems_lib  # pylint: disable=unused-import
from vitaflow.internal.data_generators import problem  # pylint: disable=unused-import
# from vitaflow.utils import cloud_mlengine
from vitaflow.utils import decoding
from vitaflow.utils import flags as t2t_flags  # pylint: disable=unused-import
from vitaflow.utils import hyperparams_lib as hparams_lib
from vitaflow.utils import mlperf_log
from vitaflow.utils import registry
from vitaflow.utils import trainer_lib
from vitaflow.utils import usr_dir
...
def save_metadata(hparams):
  ...
  if hasattr(FLAGS, "flags_into_string"):
    ...
    t2t_flags_str = "\n".join([
        "--%s=%s" % (f.name, f.value)
        for f in FLAGS.flags_by_module_dict()["vitaflow.utils.flags"]
    ])
  else:
