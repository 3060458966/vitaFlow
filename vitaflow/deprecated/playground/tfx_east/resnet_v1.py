...
from tfx_east import resnet_utils
...
def resnet_v1(inputs,
    ...
    methods for specific _model instantiations, obtained by selecting different
...
def resnet_v1_50(inputs,
                 ...
                 reuse=None,
                 scope='resnet_v1_50'):
    """ResNet-50 _model of [1]. See resnet_v1() for arg and return description."""
    blocks = [
        resnet_utils.Block(
...
def resnet_v1_101(inputs,
                  ...
                  reuse=None,
                  scope='resnet_v1_101'):
    """ResNet-101 _model of [1]. See resnet_v1() for arg and return description."""
    blocks = [
        resnet_utils.Block(
            'block1', bottleneck, [(256, 64, 1)] * 2 + [(256, 64, 2)]),
        resnet_utils.Block(
...
def resnet_v1_152(inputs,
                  ...
                  reuse=None,
                  scope='resnet_v1_152'):
    """ResNet-152 _model of [1]. See resnet_v1() for arg and return description."""
    blocks = [
        resnet_utils.Block(
            'block1', bottleneck, [(256, 64, 1)] * 2 + [(256, 64, 2)]),
        resnet_utils.Block(
...
def resnet_v1_200(inputs,
                  ...
                  reuse=None,
                  scope='resnet_v1_200'):
    """ResNet-200 _model of [2]. See resnet_v1() for arg and return description."""
    blocks = [
        resnet_utils.Block(
            'block1', bottleneck, [(256, 64, 1)] * 2 + [(256, 64, 2)]),
        resnet_utils.Block(
